...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-aurjo18071248_api1.business.example.com";
    private string APIPassword = "VXQ2BRS3MAH8G78V";
    private string APISignature = "AD-buMcfHnpK0KObrghXXa0Ma0B3A1XjiTqGzBJs9FyeliZK3.J5WHke";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        encoder["PAYMENTREQUEST_0_AMT"] = Convert.ToString(amt, invC);
        encoder["PAYMENTREQUEST_0_ITEMAMT"] = Convert.ToString(amt, invC);
